...
export const InputWithBlank = ({ index, correctAnswer, width  }) => {
  ...
  const handleCheck = () => {
    const isValidAnswer = inputValue.replaceAll(' ', '').toLowerCase() === correctAnswer.toLowerCase();
