...
export const useQuestions = create((set) => ({
  QStore: [
    ...
    },
    {
      ...
      value: 150,
      options: [{ id: 0, textorder:'1', text: 'Механическая сборка' },
    ...
    {
      id: 6,
      question: "Следующим этапом после формальной экспертизы является публикация сведений о заявке на изобретение, которая проводится по истечении ___ месяцев с момента подачи заявки.",
      value: 200,
      options: [
        {
          id: "A",
    ...
    {
      id: 8,
      question: "Под ___ в сварочном производстве понимают способность однородных и разнородных металлов и сплавов образовывать сварные соединения.",
      value: 100,
      options: [
        {
          id: "A",
    ...
    {
      id: 11, 
      question: "Дополните список сварных соединений.",
      value: 250,
      options: [
        {
          id: "A", 
