...
export const data = [
  {
    ...
    link: '/infographic',
    collapse_t: (
      <ul className='flex flex-col gap-4 text-lg text-black mb-4'>
        <li>
          {' '}
        ...
        <li>
          {' '}
          Осуществить постановку учебной проблемы: МДК. 01.02 Технология
  ...
  },
  {
    ...
    link: '/simulator',
    collapse_t: (
      <ul className='gap-4 flex flex-col list-inside text-lg mb-4'>
        <li>
          {' '}
        ...
        <li>
          ...
          смысления изученного материала, глубины его понимания
        </li>
        <li>
          {' '}
    ...
    collapse_s: (
      <>
        <p className='text-lg text-black  mb-4'>
          Повторите ранее пройденный материал МДК. 01.02 Технология производства
          сварных конструкций.{' '}
        </p>
        <p className='text-lg text-black  mb-4'>
          Запустите виртуальный тренажер по теме «Проектирование технологических
  ...
  },
  {
    ...
    collapse_t: (
      <>
        <ul className='text-lg flex flex-col gap-4 mb-4'>
          <li>
    ...
    collapse_s: (
      <>
        <p className='text-lg text-black  mb-4'>
          Запустите интерактивную мини-игру / интерактивный тренажер по теме
        ...
        <p className='text-lg text-black  mb-4'>
          ...
          умений и навыков (выбрать из списка, указать количество):
        </p>
        <ul className='flex flex-col gap-4 text-lg text-black  mb-4'>
          ...
          <li> Интерактивное задание с выбором элементов из списков;
          </li>
          <li> Интерактивное задание с вводом строки;
          </li>
          <li> Интерактивное задание на установление соответствия;
          </li>
          <li> Интерактивное задание на распределение по группам (классификацию);
          </li>
          <li> Интерактивное задание на упорядочивание (выстраивание по порядку);
          </li>
          <li> Интерактивное задание на установление связей;
          </li>
          <li> Интерактивное задание на обозначение объектов на рисунке;
          </li>
