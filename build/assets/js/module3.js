...
const HeaderInner = ({ title, subtitle }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "w-full relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex max-h-full w-full bg-blue-100 items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-dela text-center text-white", children: title }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: subtitle !== void 0 ? "border-b border-blue-400 h-auto pb-4 w-[95%] m-auto my-4" : "border-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-blue-100 text-xl text-center font-medium max-w-4xl mx-auto", children: subtitle }) })
  ] });
};
...
const useQuestions = create((set) => ({
  questions: [
    ...
    {
      id: 8,
      question: "Соединение, при котором начало соединяется с концом называется",
      value: 250,
      options: [
    ...
    {
      id: 10,
      question: "Соединение, состоящее из 3 ветвей и имеющих один общий узел называется",
      value: 150,
      options: [
        { id: 1, text: "Параллельное", isCorrect: 0 },
        { id: 2, text: "Последовательное", isCorrect: 0 },
...
const MenuItem = ({ question, id: id2 }) => {
  ...
  const filteredAnswer = [...correctAnswers, ...unCorrectAnswer].map((el2) => el2.id);
  const handleClick = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: `${filteredAnswer.indexOf(id2) !== -1 ? "hidden" : " "} ${colorClass} p-12 mx-4 my-2 rounded shadow text-center text-blue-100 max-w-[254px] cursor-pointer`,
      onClick: handleClick,
...
const MenuList = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "flex flex-wrap max-w-4xl px-12", children: [
    questions.map((question) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "w-1/4 transition-all duration-100 hover:scale-110 ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MenuItem, { question, id: question.id }) }, question.id)),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-black font-semibold flex w-full justify-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mr-12", children: [
        "Количество очков: ",
        score
      ] }),
